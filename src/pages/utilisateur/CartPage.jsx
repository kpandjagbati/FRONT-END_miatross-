/**
 * @fileoverview Page du panier d'achat
 * @description Affiche les articles du panier, gère les quantités, applique des codes promo
 * et calcule le total. Permet la suppression d'articles et la modification des quantités.
 * @version 1.0.0
 */
...
/**
 * Composant CartItem
 * @component Affiche un article du panier avec gestion de la quantité
 * @param {Object} props - Props du composant
 * @param {Object} props.item - Article du panier
 * @param {number} props.item.id - ID unique de l'article
 * @param {string} props.item.name - Nom du produit
 * @param {string} props.item.img - URL de l'image
 * @param {number} props.item.price - Prix unitaire
 * @param {number} [props.item.oldPrice] - Ancien prix
 * @param {number} props.item.quantity - Quantité en panier
 * @param {number} props.item.stock - Quantité disponible
 * @param {Function} props.onUpdateQuantity - Callback pour mettre à jour la quantité
 * @param {Function} props.onRemove - Callback pour supprimer l'article
 * @param {Function} props.onOpenDetails - Callback pour voir les détails
 * @returns {JSX.Element} Ligne de panier avec contrôles de quantité
 * @example
 * <CartItem item={cartItem} onUpdateQuantity={handleUpdate} onRemove={handleRemove} />
 */
